...
class Project {
  ...
  static setProperties(state, layerID, properties) {
    state = Layer.setPropertiesOnSelected(state, layerID, properties)
      .updatedState;
  ...
  static updateProperties(state, layerID, properties) {
    state = Layer.updatePropertiesOnSelected(state, layerID, properties)
      .updatedState;
  ...
  static setReadOnly(state, readOnly) {
    state = state.set('readOnly', readOnly);
    return { updatedState: state };
  }
}
